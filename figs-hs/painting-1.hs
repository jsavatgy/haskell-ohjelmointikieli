...
layers1 = [
  ...
  Layer "2" Air1 [rect1] "[line width=1.0pt]",
  Layer "3" Sonne1 [sonne1] "[line width=1.0pt]",
  Layer "1" Vege4 vege4 "[line width=1.0pt]",
  Layer "1" Vege3 vege3 "[line width=1.0pt]",
  Layer "1" Vege2 vege2 "[line width=1.0pt]",
  Layer "1" Vege1 vege1 "[line width=1.0pt]",
  Layer "1" Sand1 sandy1 "[line width=1.0pt]",
...
--A5= 148 × 210 mm 
tpict = tikzPictureWithScale layers1 0.82
